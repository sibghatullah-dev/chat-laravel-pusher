...
<head>
		<meta charset="utf-8">
		<title>My-Technology Chat</title>
	...
	<body>
		<main>
			<div class="layout" style="width: 1005px;margin-left: 263px;margin-top: 30px;">
				<!-- Start of Navigation -->
					...
					<div class="container">
						<div class="inside">
							<div class="nav nav-tab menu">
								...
								<a href="#discussions" data-toggle="tab" class="active" onclick="window.location.reload()"><i class="material-icons active">chat_bubble_outline</i></a>
									...
									<div class="contacts">
										...
										<div class="list-group" id="contacts" role="tablist">
                                                ...
                                                @foreach ($users as $user )
                                                    <a href="#" onclick="createChat({{$user->id}})" class="filterMembers all online contact" data-toggle="list">
								...
								<div id="discussions" class="tab-pane fade active show">
									...
									<div class="discussions">
										...
										<div class="list-group" id="chats" role="tablist">
                                            ...
                                            <a href="#list-chat" onclick="Chat({{$chat->id}})" class="filterDiscussions all unread single" id="list-chat-list" data-toggle="list" role="tab">
												<img class="avatar-md" src="dist/img/avatars/avatar-female-1.jpg" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
												{{-- <div class="status">
													<i class="material-icons online">fiber_manual_record</i>
												</div> --}}
												...
												<div class="data">
                                                    @if ($chat->reciever->id == \Auth::id())
                                                        <h5>{{$chat->sender->name}}</h5>
                                                    @else
                                                        <h5>{{$chat->reciever->name}}</h5>
                                                    @endif
													{{-- <span>Mon</span> --}}
						...
						<div class="babble tab-pane fade active show" id="list-chat" role="tabpanel" aria-labelledby="list-chat-list">
							...
							<div class="chat" id="chat1">
									...
									<div class="container">
										<div class="col-md-12">
											<div class="inside">
												...
												<div class="data">
													<h5 id="name_of_reciever"><a href="#">Keith Morris</a></h5>
								...
								<div class="container">
									<div class="col-md-12">
										<div class="bottom">
											<form class="position-relative w-100"  id="sendMessage-d">
                                                @csrf
                                                {{-- Hidden Inputs --}}
												...
												<textarea class="form-control" name="message_body" id="message_body" placeholder="Start typing for reply..." rows="1"></textarea>
